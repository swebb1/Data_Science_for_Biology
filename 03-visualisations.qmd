...
<br> Bioconductor has many packages for annotating, analysing and visualising genomic data. In this section we will introduce some of these packages to give you a taste of the types of analysis you can perform. Here, we focus on ChIP-seq data but these methods can be applied to many types of genomic data.
