...
```{r, results='hide'}
## You can load all of the tidyverse packages at once. This is great for an interactive session.
library(tidyverse)

## Or individually. This is better for scripts and reproducibility as it makes it clear which packages are being used.
# library(dplyr)
# library(ggplot2)
```
...
::: {.box .resources}
<h3><i class="fas fa-book"></i> Further Resources</h3>
...
-   Take a look at these [slides](https://drive.google.com/open?id=181oNGmKKxyx3XUDvYFgxtGj4aQjCguW0LRb3r0UIviM) or [www.tidyverse.org](https://tidyverse.org/) for more information on the tidyverse.
:::
