...
If you can't see this, R may still be working. There is a red Stop light at the top right of the console when a command is running. You can use this or the <kbd>Esc</kbd> key
to kill a command if it is taking too long or you have made a mistake.
